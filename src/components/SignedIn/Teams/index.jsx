	...
	render() {
		return (
			<div id='teams' className='page wide'>
				...
				<TeamsOptions numberChanged={this.numberChanged} weeksChanged={this.weeksChanged} nameChanged={this.nameChanged} sortChanged={this.sortChanged} limitChanged={this.limitChanged} />
